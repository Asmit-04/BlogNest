                                ...
                                categoryData.category.map(category =>
                                    <TableRow key={category._id}>
                                        ...
                                        <TableCell className="flex gap-3">
                                            <Button variant="outline" className="hover:bg-orange-500 hover:text-white" asChild>
                                                <Link to={RouteEditCategory(category._id)}>
                                                    <FiEdit />
                                                </Link>
                                            </Button>
                                            <Button onClick={() => handleDelete(category._id)} variant="outline" className="hover:bg-orange-500 hover:text-white" >
                                                <FaRegTrashAlt />
                                            </Button>
                                        </TableCell>
                                    </TableRow>
