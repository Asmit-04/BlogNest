                        ...
                        {({ getRootProps, getInputProps }) => (
                            <div {...getRootProps()}>
                                ...
                                <Avatar className="w-28 h-28 relative group">
                                    ...
                                    <div className='absolute z-50 w-full h-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 justify-center items-center bg-black bg-opacity-20 border-2 border-orange-500 rounded-full group-hover:flex hidden cursor-pointer'>
